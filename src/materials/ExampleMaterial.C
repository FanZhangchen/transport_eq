...
registerMooseObject("transportEQApp", ExampleMaterial);
...
ExampleMaterial::ExampleMaterial(const InputParameters & parameters)
  : Material(parameters),
    ...
    _convection_velocity(declareProperty<Real>("convection_velocity"))
